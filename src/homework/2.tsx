...
// Для type State потрібно уточнити які значення може мати властівість requestStep, просто string буде недостатньо)
// type State = {
// ...
// requestStep: ... | ... | ... | ...;
// }
...
// Так само для type Action потрібно описати всі можливі варіанти властивості type.
type Action =
  | { type: "START_REQUEST" }
